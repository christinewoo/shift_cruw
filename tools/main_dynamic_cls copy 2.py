...
adj_thresh = {'Car' : {0.0 : (1 - 0.16), #28.99 _ 1743 iou 0.5
                       0.1 : (1 - 0.2), #31.79 _ 1814 iou0.55
                       0.2 : (1 - 0.31), #30.96 _ 1816 iou0.53
                       0.3 : (1 - 0.39), 
                       0.4 : (1 - 0.52), 
                       0.5 : (1 - 0.6)},
              'Pedestrian' : {0.0 : (1 - 0.8), 
                              0.1 : (1 - 0.18), 
                              0.2 : (1 - 0.25), 
                              0.3 : (1 - 0.36), 
                              0.4 : (1 - 0.45), 
...
def fix_obj(cur_idx_pairs, kept_dt_ids, cls='Car'):
    ...
    for pid, pair in zip(kept_dt_ids, cur_idx_pairs):
        ...
        if iou < adj_iou_thresh[cls]:
            ...
            new_obj.loc[0] = pair[0].loc[0] + (pair[1].loc[0] - pair[0].loc[0]) * adj_thresh[cls][math.floor(iou*10)/10]
...
def main():
    ...
    print(f'Added  Ped: {add_p},  Cyc: {add_cy}')
